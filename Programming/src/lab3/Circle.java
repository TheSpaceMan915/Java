...
public class Circle {
    ...
    public int FindIfCross(Circle obj2)
    {
        ...
        else if (Math.abs(m_R - R2) == dis)   //окружности соприкасаются в одной точке (но одна вложена в другую)
        {
            res = 4;
            if (m_R > R2)
                {res += 10;}      //окружность с радиусом R2 вложена
            else
                {res += 11;}      //окружность с радиусом R вложена
        }
        ...
        else                  //одна окружность лежит внутри другой не касаясь другой
        {
            res = 6;
            if (m_R > R2)
                {res += 10;}      //окружность с радиусом R2 вложена (Вторая окружность вложена в первую)
            else
                {res += 11;}      //окружность с радиусом R вложена  (Первая окружность вложена во вторую)
        }
    ...
    public static void main(String[] args)
    {
        ...
        String switcher = switch(number) {
            ...
            case 14 -> "Окружности соприкасаются в одной точке (Вторая окружность вложена в первую)";
            case 15 -> "Окружности соприкасаются в одной точке (Первая окружность вложена во вторую)";
            case 16 -> "Вторая окружность вложена в первую";
            case 17 -> "Первая окружность вложена во вторую";
            default -> "";
        };
